# ============================================================
# DQF BATCH 5 — FULL-CORPUS evidence-pool strength triage
# (paste into a fresh Kaggle notebook; GPU T4 x2, Internet ON, no dataset)
#
# Covers EVERY (drug, dim) evidence pool in the framework: 413 groups,
# ~2,573 sentences, 25 dimensions. Multi-hour run -> use DETACHED launch:
...
#
# Output: /kaggle/working/batch5_verdicts.json
# ============================================================
...
url = ('https://raw.githubusercontent.com/rikirinjani/DQF/master/'
       'rag-queries/batch5_sentences.json')
INP = '/tmp/batch5_sentences.json'
...
OUTP = '/kaggle/working/batch5_verdicts.json'
CHUNK = 8
res, t0 = {}, time.time()
